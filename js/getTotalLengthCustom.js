SVGGeometryElement.prototype.getTotalLengthCustom = function (options = {}) {
    ...
    switch (type) {
        ...
        case "ellipse":
            ...
            pathLength = getEllipseLength(rx, ry);
    ...
    if (pathData.length) {
        pathLength = getPathDataLength(pathData)
    }
...
//herrstrietzel/svgHelpers@main/js/getPointAtLengthLookup.js
